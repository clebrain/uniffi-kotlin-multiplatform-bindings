...
class InternalException(message: kotlin.String) : kotlin.Exception(message)
...
internal inline fun <U, E : kotlin.Exception> rustCallWithError(
...
internal fun <E : kotlin.Exception> checkCallStatus(errorHandler: CallStatusErrorHandler<E>, status: RustCallStatus) {
    if (status.isSuccess()) {
        return
...
internal expect class UniFfiHandleMap<T : kotlin.Any>() {
